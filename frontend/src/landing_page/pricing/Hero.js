    ...
    <div className="container mt-5">
      ...
      <div className="row border-bottom mt-5 p-5">
        <div className="col-4 p-2 mt-5 text-center">
            <img style={{width:"80%"}} src="Media\Images\pricingEquity.svg" alt="Free equity delivery" />
        ...
        <div className="col-4 p-2 mt-5 text-center">
            <img className='mx-3' style={{width:"80%"}} src="Media\Images\intradayTrades.svg " alt="Intraday and FO trades" />
        ...
        <div className="col-4 p-2 mt-5 text-center">
            <img className='mx-5' style={{width:"80%"}} src="Media\Images\pricingEquity.svg" alt="Free direct mutual funds" />
